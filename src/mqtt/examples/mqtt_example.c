...
char g_device_name[IOTX_DEVICE_KEY_LEN + 1]       = "oBLcN1Ruj2";
char g_device_secret[IOTX_DEVICE_SECRET_LEN + 1]   = "HTtewna5Gih31UFRVzCX";
 ...
 *
 *  The demo device has been configured in IoT console
...
int main(int argc, char *argv[])
{
    ...
    IOT_Ioctl(IOTX_IOCTL_SET_DEVICE_KEY, g_device_name);
    ...
    IOT_Ioctl(IOTX_IOCTL_GET_DEVICE_KEY, g_device_name);
