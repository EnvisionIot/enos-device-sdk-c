...
#define DEV_SIGN_USERNAME_MAXLEN  (100)
...
typedef enum IOT_RETURN_CODES {
    ...
    ERROR_PRODUCT_MEASUREPOINT_NOT_EXIST = -6206, /**< product measurepoint not exist*/
    ...
    ERROR_DSL_PARSE_NO_MEASUREPOINT = -6320, /**< dsl parse: no measurepoint exist in product*/
    ERROR_DSL_PARSE_IDENTIFIER_IS_NULL = -6321, /**< dsl parse: template measurepoint/params idetifier is null*/
     ...
     * -6450 ~ -6469
     */
    ERROR_ENOS_METHOD_NOT_EXIST = -6450, /**< EnOS method not exist*/
