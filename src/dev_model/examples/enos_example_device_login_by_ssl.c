...
static char g_product_key[IOTX_PRODUCT_KEY_LEN + 1] = "hHKPPzEb";
static char g_product_secret[IOTX_PRODUCT_SECRET_LEN + 1] = "W9sQLIvGhSS";
static char g_device_key[IOTX_DEVICE_KEY_LEN + 1] = "ca-device";
static char g_device_secret[IOTX_DEVICE_SECRET_LEN + 1] = "NOcB2aEhmxPrnT6TVfnz";
