                              ...
                              const char *client_pwd, size_t client_pwd_len)
{
...
#elif (TLS_AUTH_MODE == TLS_AUTH_MODE_PSK)
    {
        ...
        /* psk identity length */
        psk_identity_len = strlen(auth_type) + strlen(sign_method) + strlen(product_key) + strlen(device_key) + strlen(
                                       timestamp) + 5;
        ...
        memcpy(psk_identity + strlen(psk_identity), "&", strlen("&"));
        memcpy(psk_identity + strlen(psk_identity), device_key, strlen(device_key));
        memcpy(psk_identity + strlen(psk_identity), "|", strlen("|"));
        ...
        memcpy(string_to_sign + strlen(string_to_sign), device_key, strlen(device_key));
...
{
    "-----BEGIN CERTIFICATE-----\r\n" \
    "MIIEtTCCA52gAwIBAgICEmAwDQYJKoZIhvcNAQELBQAwgYIxCzAJBgNVBAYTAkNO\r\n" \
    ...
    "hkiG9w0BCQEWC2NhQGVuaW90LmlvMB4XDTE5MTIxMDA4NDc1MVoXDTIxMTIwOTA4\r\n" \
    "NDc1MVowYzELMAkGA1UEBhMCQ04xETAPBgNVBAgMCFNoYW5naGFpMREwDwYDVQQH\r\n" \
    "DAhTaGFuZ2hhaTENMAsGA1UECgwEVEVTVDENMAsGA1UECwwERW5vczEQMA4GA1UE\r\n" \
    "AwwHemhvdW1pbjCCASIwDQYJKoZIhvcNAQEBBQADggEPADCCAQoCggEBAKTpm0Kp\r\n" \
    "HcUHlTB5Hg44sbBQvT5SJ2QECfWSG6Bkak1pNVmU3w7F6d8OVGgZDFSqbK8qF6Pf\r\n" \
    "KXNoXeL4Yu5c537rvrxnFFh+fUURFgEnJlqGjgGZE9/na3JvzF/7fvT0NClGff/Y\r\n" \
    "GJYL5Tpshv1vBN3Jevhf8JwLsfAyMk4rSlVsmb1karxCFG5KSiS/OW1Prf+gmZe8\r\n" \
    "9fLzd5ixyTiOzk0EYT/tROQ/hl1CvLQ21ey+i1aHLV3WbEN+6eK8wVbxgIoT1ltO\r\n" \
    "eFAnDo8qz9DV1D4pnEbXLN+kcfsQaBobVFKtDGnT5sk5nR2r+RdLyfXDwUFsJwvl\r\n" \
    "tHk3Z0rcKiIUaCsCAwEAAaOCAVEwggFNMAkGA1UdEwQCMAAwJwYJYIZIAYb4QgEN\r\n" \
    "BBpFbm9zIEdlbmVyYXRlZCBDZXJ0aWZpY2F0ZTAdBgNVHQ4EFgQU6ouT4IepP6+h\r\n" \
    "kPQ/uv55YnHkqEYwgbcGA1UdIwSBrzCBrIAUrk/3r6cZewuuLnkPtHvlroz0VA2h\r\n" \
    "gYikgYUwgYIxCzAJBgNVBAYTAkNOMREwDwYDVQQIDAhTaGFuZ2hhaTERMA8GA1UE\r\n" \
    "BwwIU2hhbmdoYWkxDTALBgNVBAoMBEVuT1MxEDAOBgNVBAsMB0VuT1MgQ0ExEDAO\r\n" \
    "BgNVBAMMB0VuT1MgQ0ExGjAYBgkqhkiG9w0BCQEWC2NhQGVuaW90LmlvggkAjFSp\r\n" \
    "kVfI7ygwPgYJYIZIAYb4QgEEBDFodHRwczovL2JldGEtcG9ydGFsLWNuNC5lbmlv\r\n" \
    "dC5pbzo4MDgxL2Vub3MvQ0EvY3JsMA0GCSqGSIb3DQEBCwUAA4IBAQCRsqkf157m\r\n" \
    "5tCDiCii5+ZMqzoMz6mYg7a5haEJTyVEWf+aQ9yn1cQfmUH6fYD/+G2Rf2QCH1Bh\r\n" \
    "fYcMOjn4eEQaBkO/dR5Vtg3mbsOZrRuSkIGFgAdiYpqKF5SS+gkj7IIXyX+MyhlM\r\n" \
    "IXB6XIVNERzR1+41+VA7cZEURdN48nWE85QwScgIbRjtLplGwfgQG5dNIqduCmzN\r\n" \
    "oOOlJ7mZ65xxXC9HV2dPttTgKMnwhC/9zSjuh2HdhR3QhK7u+MHHOc5XweTkT6Al\r\n" \
    "H+WvAM1ggVcUzc0BNbaZiLUQY22ZvCvmbL9q0m6e9Ies23gJctDcDV/GFR2BDLcV\r\n" \
    "sp6ZsDZDwJ+B\r\n" \
    "-----END CERTIFICATE-----\r\n"
};
/*
...
{    
    ...
    "MIIEowIBAAKCAQEApOmbQqkdxQeVMHkeDjixsFC9PlInZAQJ9ZIboGRqTWk1WZTf\r\n" \
    "DsXp3w5UaBkMVKpsryoXo98pc2hd4vhi7lznfuu+vGcUWH59RREWAScmWoaOAZkT\r\n" \
    "3+drcm/MX/t+9PQ0KUZ9/9gYlgvlOmyG/W8E3cl6+F/wnAux8DIyTitKVWyZvWRq\r\n" \
    "vEIUbkpKJL85bU+t/6CZl7z18vN3mLHJOI7OTQRhP+1E5D+GXUK8tDbV7L6LVoct\r\n" \
    "XdZsQ37p4rzBVvGAihPWW054UCcOjyrP0NXUPimcRtcs36Rx+xBoGhtUUq0MadPm\r\n" \
    "yTmdHav5F0vJ9cPBQWwnC+W0eTdnStwqIhRoKwIDAQABAoIBAFm8F9TNCzrkJmUK\r\n" \
    "8rTQWrfTJzabI34DyJuMlmXPXhyjS/ljzYBPZzQNqxY90vzbA2rJH7X2v6phtvzD\r\n" \
    "JaoIeZsRkmcYO/TvVyDW7D9SW0dVAj6SWkMyvL+3X+E2i12k6CExj2xA3RgAfwos\r\n" \
    "dcO/vkkk0joGknmGz5sg5Uitu7QBFVTRTKDfKjRvYC5Pb+XI1Z6GQzj/OiffQAYZ\r\n" \
    "NJMUVfHwrxv7qUJCRs9t6NKwjqjbh+AKbUNdM18p57NqvPG5fkuXbVNjLc+dRxfw\r\n" \
    "vtpbHOIkqBRx8FLziGgFe4lfqkbaZqX6j4fBt3WCXBfcr0Z37YcZ+l5CWjsb7Q95\r\n" \
    "STyNlQkCgYEA1j/k4bP3fC9MtpG188PyccB6TVZU7wITHO+9qNyIMBEzUcqjNkJY\r\n" \
    "jJWl5qJAtbBzV2ubMbouxSqeTilFdT1QoKvi5Zh83POd+kLEjY64dV5RAeYOKqVX\r\n" \
    "rjWzm680i6wbU5ZlTpw3nlPPGfyFoPHcoKoONL6UFZm8eJ1ljNrXuOcCgYEAxQx4\r\n" \
    "124LPfZYUXBsWBDynxShhbKardLd0Emu7Q0aj3U4Y/CKzrE16Y0AH4aOKUycDvx8\r\n" \
    "Zu8MsBM7oM4ASw5N8E57iPj4qjG05nX3IG5zYIQ4aJQgj9mh4yb8kFq2SXRdF1wQ\r\n" \
    "Gsab4GZAli6AtIhKicJZdq7USoi+8wvrF02bGh0CgYBbPrT0ptekzOQn8OCD45Sy\r\n" \
    "e13a6ASeEc0gCr5EVz+s8PZhRCLEbfcWUHlqQvm6J17IAW0D/Z4DnIX1FcCeELHw\r\n" \
    "66NjUtECrMJAHgVloD3Qxo1LeLXZ1bcE25wVlsWTIoY00B1vIDrTtC/EinZCuB7V\r\n" \
    "Ufdg4TViCapp1+ay2VT8SwKBgCYiOsSeREiygvcHxb/pT7rfmD6yiOK42zpy+Api\r\n" \
    "LdCzg707kPFdNCzFn896D8sIS29PB5g4DQGKR1DgbQgZdZXa6mdgn2b4haTQEYpS\r\n" \
    "Nbvo+q2qdP7BxGWcZuZc18gxX86kf21fIE12HGu0Bi5p7drpJL0mKmleO2330YBK\r\n" \
    "AYk1AoGBALZPUOVQRUz6EMIed+9NL3jG41BfVZ0OVEK0bvo0rqlgZ77XC3twSzfs\r\n" \
    "EIArTmiKpr4CWtMuKTQdiGXM4P/C7FuJRRWkc/I79udQzDxlrUmwzx4K7UXSf1w4\r\n" \
    "d5kXmoXYs6tFBqDHP11njoep55WE/9yn0a1gLDe2FmyX0YeeGx4D\r\n" \
    "-----END RSA PRIVATE KEY-----\r\n"
};
/*
{
